    ...
    public static void main(String[] args) {
        ...
        for (;;) {
            ...
            if (password == 12345) {
                ...
                for ( num = 1; num <= 4; num++){
                    if (password == 1){
                        System.out.println("Input password at 1 on correct\n");
                        break;
                    }
                    else if (password == 2){
                        System.out.println("Input password at 2 on correct\n");
                        break;
                    }
                    else if (password == 3){
                        System.out.println("Input password at 3 on correct\n");
                        break;
                    }
                    else if (password == 4){
                        System.exit(0);
